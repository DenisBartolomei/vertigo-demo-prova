...
def run_full_generation_pipeline(position_id: str, collection_name: str = "positions_data", reasoning_steps_count: int = 5) -> bool:
    """
    ...
    case_collection = generate_final_cases(icp_text, case_guide_text, kb_summary, seniority_level, hr_special_needs, reasoning_steps_count)
