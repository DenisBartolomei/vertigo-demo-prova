...
o	Ciascun case dovrà essere in grado di verificare le skill riportate nei paragrafi della ICP: “**Competenze tecniche richieste esplicitamente dall'annuncio**”, "**Competenze trasversali richieste esplicitamente dall'annuncio (escluse le lingue)**". Per fare ciò, dovrai quindi attribuire a ciascun reasoning step almeno 3 skill che secondo te sono ideali da verificare in quel contesto (secondo lo schema imposto).
