...
def create_failed_transition_prompt(current_step_title: str, criteria: str, skills_to_test: str, next_step_title: str, next_step_description: str) -> str:
    ...
    return (
        ...
        f"Devi essere bravo a costruire il messaggio in modo appropriato: (1) se il candidato non ha risposto per nulla, o comunque con niente di minimamente valido, fallo notare e invitalo a rispondere in modo completo; (2) nel caso in cui il candidato risponda in modo propositivo, o almeno ci provi, l'avvio del messaggio deve essere incoraggiante"
    )
