...
gcloud run deploy vertigo-ai-backend \
    ...
    --max-instances 10 \
    --min-instances 0 \
    --set-env-vars MONGODB_URI="${MONGODB_URI}",AZURE_OPENAI_ENDPOINT="${AZURE_OPENAI_ENDPOINT}",AZURE_OPENAI_API_KEY="${AZURE_OPENAI_API_KEY}",AZURE_OPENAI_API_VERSION="${AZURE_OPENAI_API_VERSION}",AZURE_OPENAI_DEPLOYMENT_NAME="${AZURE_OPENAI_DEPLOYMENT_NAME}",JWT_SECRET="${JWT_SECRET}",PYTHON_ENV=production,AZURE_OPENAI_BATCH_ENDPOINT="${AZURE_OPENAI_BATCH_ENDPOINT}",AZURE_OPENAI_BATCH_API_KEY="${AZURE_OPENAI_BATCH_API_KEY}",AZURE_OPENAI_BATCH_API_VERSION="${AZURE_OPENAI_BATCH_API_VERSION}",AZURE_OPENAI_BATCH_DEPLOYMENT_NAME="${AZURE_OPENAI_BATCH_DEPLOYMENT_NAME}",AZURE_OPENAI_CLASSIFICATION_ENDPOINT="${AZURE_OPENAI_CLASSIFICATION_ENDPOINT}",AZURE_OPENAI_CLASSIFICATION_API_KEY="${AZURE_OPENAI_CLASSIFICATION_API_KEY}",AZURE_OPENAI_CLASSIFICATION_DEPLOYMENT_NAME="${AZURE_OPENAI_CLASSIFICATION_DEPLOYMENT_NAME:-gpt-4.1-mini}",AZURE_OPENAI_CLASSIFICATION_API_VERSION="${AZURE_OPENAI_CLASSIFICATION_API_VERSION}",WHATSAPP_API_TOKEN="${WHATSAPP_API_TOKEN}",WHATSAPP_PHONE_NUMBER_ID="${WHATSAPP_PHONE_NUMBER_ID}",WHATSAPP_VERIFY_TOKEN="${WHATSAPP_VERIFY_TOKEN}",WHATSAPP_BUSINESS_ACCOUNT_ID="${WHATSAPP_BUSINESS_ACCOUNT_ID}",CANDIDATE_FRONTEND_URL="${CANDIDATE_FRONTEND_URL:-https://vertigo-candidate.web.app}"
